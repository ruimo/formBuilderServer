...
class UsersSpec extends Specification {
  ...
  "Users" should {
    ...
    "find by primary keys" in new AutoRollback {
      val maybeFound = Users.find(1L, "MyString", "MyString", 1L, 1L, DateTime.now)
    ...
    "create new record" in new AutoRollback {
      val created = Users.create(userId = 1L, userName = "MyString", email = "MyString", hash = 1L, salt = 1L, createdAt = DateTime.now)
    ...
    "destroy a record" in new AutoRollback {
      ...
      val shouldBeNone = Users.find(1L, "MyString", "MyString", 1L, 1L, DateTime.now)
